...
public:
    ...
    inline void set (const std::string & name, const glm::mat3 & value)
    ...
    inline void set (const std::string & name, const std::vector<glm::vec3>& value)
    { glUniform3fv (getLocation (name.c_str ()), value.size(), glm::value_ptr(value[0])); }
